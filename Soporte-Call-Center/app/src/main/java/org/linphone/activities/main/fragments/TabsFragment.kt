...
import org.linphone.activities.navigateToUsers
    ...
    override fun onDestinationChanged(
        ...
        if (corePreferences.enableAnimations) {
            when (destination.id) {
                ...
                R.id.genericAccountListContactFragment -> binding.motionLayout.transitionToState(
                    R.id.users
                )
            }
        } else {
            when (destination.id) {
                ...
                R.id.dialerFragment -> binding.motionLayout.setTransition(
                    R.id.dialer,
                    R.id.dialer
                )

                R.id.genericAccountListContactFragment -> binding.motionLayout.setTransition(
                    R.id.users,
                    R.id.users
                )
            }
