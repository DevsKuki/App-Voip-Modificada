...
open class StatusViewModel : ViewModel() {
    ...
    val displayameStatus = MutableLiveData<String>()
    private lateinit var userviewModel: GenericLoginViewModel
    ...
    private val listener: CoreListenerStub = object : CoreListenerStub() {
        override fun onAccountRegistrationStateChanged(
            ...
            if (account == core.defaultAccount) {
                ...
                displayameStatus.value = account.params.identityAddress?.displayName
    ...
    init {
        ...
        if (defaultAccount != null) {
            ...
            username.value = defaultAccount.params.identityAddress?.username
            displayameStatus.value = defaultAccount.params.identityAddress?.displayName
        }
        updateDefaultAccountRegistrationStatus(state)
    }
