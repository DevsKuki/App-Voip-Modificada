...
### MODIFICACIONES Y VERSIONES DE UPEAVOZ 
# CHANGELOG

## [1.0.0] - 2024-06-21

### Added
- Nueva funcionalidad de conexión a una **API personalizada** para:
    - Registro SIP con un nuevo campo `id` que mejora la gestión de usuarios.
    - Agenda de contactos integrada para realizar llamadas desde la API.
- Nuevos **diálogos personalizados** para el registro SIP con más opciones visuales.
- **Nuevos colores e iconos** para personalizar la interfaz, adaptados a la identidad de UpeaVoz.
- Interfaz adaptada a **pantallas pequeñas** para mejorar la experiencia del usuario.

### Changed
- **Interfaz de usuario (UI)**:
    - Eliminación de las funcionalidades de mensajería y video, manteniendo el enfoque en las llamadas.
    - **Menú/tabbar** reemplazado, eliminando la opción de mensajería y ofreciendo solo la agenda de contactos.
    - El asistente de **login SIP** ahora solo permite el registro mediante **API personalizada** para simplificar el proceso de conexión.
    - Rediseño de la **iconografía y colores**, adaptados a una identidad visual moderna y consistente.
    - El diseño se simplificó para mejorar la usabilidad en dispositivos con pantallas más pequeñas.

- **Llamadas SIP**:
    - Ajuste de la visualización de **extensiones** en lugar de los **dominios** en la configuración de llamadas.

- **Configuraciones**:
    - Eliminación de preferencias relacionadas con la mensajería, video y contactos.
    - Simplificación del asistente de configuración, enfocándose en los parámetros esenciales para la conexión SIP.

### Removed
- **Permisos** para vincular contactos del teléfono con la aplicación.
- Opciones adicionales en el asistente de login SIP, como la creación de cuenta, búsqueda de configuración remota y **Linphone Account**.

---

## Cambios de Linphone en versiones anteriores
Este proyecto utiliza una **versión antigua del repositorio oficial de Linphone**, disponible en GitLab:
- [Repositorio oficial de Linphone - GitLab](https://gitlab.linphone.org/BC/public/linphone-android.git)

### Resumen de las modificaciones realizadas:
- Este fork de Linphone se ha **modificado para adaptarse a los requisitos de UpeaVoz**, eliminando funcionalidades no esenciales y ajustando el diseño para una experiencia más sencilla y accesible.
- No se realizaron modificaciones importantes en el **núcleo (core)** de Linphone, preservando la estabilidad y funcionalidad base.
- Los cambios se enfocaron en:
    - **Interfaz de usuario (UI)**: adaptada a entornos más compactos, con una nueva paleta de colores y rediseño visual.
    - **Eliminación de ciertas funcionalidades** como mensajería y video, lo que simplifica la app para los usuarios que solo necesiten realizar llamadas.
    - **Ajustes menores en la lógica de algunas funcionalidades**, como la gestión de llamadas y el registro SIP, para personalizar el uso según los requerimientos de UpeaVoz.

### Versión anterior de Linphone (2024-09-21):
- Introducción de la funcionalidad de mensajería y video (posteriormente eliminadas en esta versión personalizada).
- Soporte para **múltiples cuentas SIP**.
- Integración básica con **contactos del teléfono**.
- Opciones avanzadas de configuración para **video y chat**.

### Enlace al repositorio original de Linphone:
- Para acceder a la funcionalidad completa sin modificaciones, puedes consultar el repositorio oficial de Linphone en **GitLab**:  
  [Linphone GitLab - Repositorio oficial](https://gitlab.linphone.org/BC/public/linphone-android.git)

---

## Consideraciones importantes:
Este proyecto ha sido modificado bajo los términos de la **Licencia Pública General GNU versión 3 (GPLv3)**. Al distribuir este software, los siguientes términos son aplicables:
1. **Código fuente**: El código fuente completo de esta aplicación debe estar disponible para su distribución, y puedes obtenerlo contactando a través de los medios indicados en la documentación.
2. **Atribución**: Debes mantener los créditos y atribuciones de los desarrolladores originales de Linphone. El código y los elementos visuales modificados en esta app están basados en **Linphone**.
3. **Distribución bajo la misma licencia**: Las modificaciones realizadas deben seguir estando bajo la **GPLv3**, por lo que no está permitido cambiar la licencia a una propietaria.

Este proyecto sigue siendo un **software de código abierto** y cumple con las condiciones de la **GPLv3**, proporcionando un sistema basado en **Linphone** con personalización específica para el registro SIP y la gestión de contactos de UpeaVoz.

---

### Créditos:
- Este proyecto se basa en el **proyecto Linphone**, mantenido por **Belledonne Communications**.
- El código original y las modificaciones realizadas en este proyecto se distribuyen bajo la **Licencia Pública General GNU versión 3 (GPLv3)**.
- Puedes consultar el código original de Linphone en su repositorio oficial: [Linphone GitLab](https://gitlab.linphone.org/BC/public/linphone-android.git).
- Los iconos y la interfaz de usuario original también están sujetos a la misma licencia, y se agradece el trabajo de los desarrolladores de **Belledonne Communications**.